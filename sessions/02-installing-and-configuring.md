...
1) In the same text format screen, enable **Content Suggestions** if available.
...
> Governance note: Keep high-impact actions behind roles that receive training. Prefer drafts or review fields to keep humans in the loop before publishing.
